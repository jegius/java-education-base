...
public class GenAlexArrayList<T> {

    private Object[] values;
    private int size;

    public GenAlexArrayList() {
        this.size = 0;
    ...
    public boolean compare(GenAlexArrayList listForComparison) throws OutOfArrayLength {
    ...
    private boolean isEqual(int index, GenAlexArrayList listForComparison) throws OutOfArrayLength {
